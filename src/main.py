...
def main():
    ...
    parser.add_argument('--step', type=str, help='step to load from the checkpoint folder')
    ...
    if train_configs['distributed_data_parallel'] and world_size > 1:
        ...
        prepare_train_eval(rank, gpus_per_node, world_size, run_name, train_configs, model_configs, hdf5_path_train=hdf5_path_train, step_ppp=args.step)
